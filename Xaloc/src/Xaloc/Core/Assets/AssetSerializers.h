...
namespace Xaloc {
	...
	public:
		...
		virtual bool GetInvalidAsset(Ref<Asset>& asset) = 0;
	};
	...
	public:
		...
		virtual bool GetInvalidAsset(Ref<Asset>& asset) override;

	private:
		Ref<Asset> m_InvalidAsset;
	};
	...
	public:
		virtual void Serialize(const AssetMetadata& metadata, const Ref<Asset>& asset) const override {}
		virtual bool TryLoadData(const AssetMetadata& metadata, Ref<Asset>& asset) const override;
		virtual bool GetInvalidAsset(Ref<Asset>& asset) override { return false; }
	};
	...
	class RoomAssetSerializer : public AssetSerializer
	{
	public:
		virtual void Serialize(const AssetMetadata& metadata, const Ref<Asset>& asset) const override;
		virtual bool TryLoadData(const AssetMetadata& metadata, Ref<Asset>& asset) const override;
